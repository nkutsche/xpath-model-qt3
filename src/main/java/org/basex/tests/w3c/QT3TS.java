...
public final class QT3TS extends Main {
  ...
  /** Path to the test suite (ignored if {@code null}). */
  private String logFile = "tests.log";
  ...
  private void run() throws Exception {
    ...
    try(PrintOutput po = new PrintOutput(new IOFile(logFile))) {
    ...
    if(report != null) {
      ...
      final String file = report.hasFile() ? report.getFile() :  "ReportingResults/results_" + NAME + '_' + VERSION + IO.XMLSUFFIX;
